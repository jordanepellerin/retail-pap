...
export default function WidgetLauncher({ open, onToggle }: WidgetLauncherProps) {
  return (
    <button
      ...
      className={
        open
          ? // Ouvert : croix sur fond noir (masqué sur mobile, panneau plein écran)
            'fixed bottom-6 right-6 z-50 hidden h-14 w-14 items-center justify-center border border-noir-encre bg-noir-encre text-white shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-200 hover:bg-black sm:flex'
