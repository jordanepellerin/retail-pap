...
export function HeartIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 21s-6.716-4.35-9.428-7.062C.86 12.226.5 10.66.5 9.2.5 6.6 2.6 4.5 5.2 4.5c1.54 0 3.04.72 4 1.86.96-1.14 2.46-1.86 4-1.86 2.6 0 4.7 2.1 4.7 4.7 0 1.46-.36 3.026-2.072 4.738C18.716 16.65 12 21 12 21z" />
    </svg>
  )
}
